...
var defaultOptions = {
  ...
  defaultUrl: {
    value: '/laojunsen/pdfjs/web/compressed.tracemonkey-pldi-09.pdf',
  ...
  cMapUrl: {
    value: '/laojunsen/pdfjs/web/cmaps/',
    kind: OptionKind.API
  },
  disableAutoFetch: {
    value: false,
  ...
  workerSrc: {
    value: '/laojunsen/pdfjs/build/pdf.worker.js',
    kind: OptionKind.WORKER
  }
};
{
...
if (typeof window !== 'undefined' && window['pdfjs-dist/build/pdf']) {
  ...
  pdfjsLib = require('/laojunsen/pdfjs/build/pdf.js');
}
